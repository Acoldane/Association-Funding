...
@Component({
  selector: 'app-read-event-list',
  templateUrl: './read.component.html',
  styleUrls: ['./read.component.css'],
})

export class ReadEventListComponent implements OnInit {

  event: Evenement[] | null = null;
  event$: Observable<AssoState<Evenement[]>> | null = null;
  ...
  getAllAssosObs() {
    this.event$ = this.evenementService.getAll().pipe(
